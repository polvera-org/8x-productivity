 ...
 */
export function runWithGitclaw(agentDir, manifest, options = {}) {
    ...
    if (exp.rulesMd)
        writeFileSync(join(workspaceDir, 'RULES.md'), exp.rulesMd, 'utf-8');
    if (exp.dutiesMd)
        writeFileSync(join(workspaceDir, 'DUTIES.md'), exp.dutiesMd, 'utf-8');
...
//# sourceMappingURL=gitclaw.js.map