 ...
 */
export function exportToGeminiString(dir) {
...
function buildInstructions(agentDir, manifest) {
    const parts = [];
    // Agent identity
...
function buildSettings(agentDir, manifest) {
    const settings = {};
 ...
 */
function buildHooksConfig(agentDir) {
    try {
        ...
        const hooksConfig = yaml.load(hooksYaml);
