 ...
 */
export function exportToCodex(dir) {
 ...
 */
export function exportToCodexString(dir) {
...
function inferProvider(model) {
    ...
    if (model.startsWith('llama') || model.startsWith('mistral') || model.startsWith('qwen'))
        return 'ollama';
    if (model.startsWith('o1') || model.startsWith('o3') || model.startsWith('o4') || model.startsWith('gpt'))
        return 'openai';
